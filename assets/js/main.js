...
(function($) {
  ...
  const locales = [
    "en-GB","ar-SA","zh-CN","de-DE","es-ES","fr-FR",
    "hi-IN","it-IT","id-ID","ja-JP","ko-KR","nl-NL",
    "no-NO","pl-PL","pt-BR","sv-SE","fi-FI","th-TH",
  ...
  $(document).ready(function () {
    ...
    function setSelectedLocale(locale) {
      ...
      $.each(otherLocales, function (index, otherLocale) {
        ...
        const $listEl = $("<li>").html(`
          ${langName}
          <img src="${getFlagSrc(otherIntlLocale.region)}" />
        `);
      ...
      // ✅ ACTIVE BUTTON – ALWAYS INDIAN FLAG 🇮🇳
      $("#language_active_btn").html(`
        <span>
